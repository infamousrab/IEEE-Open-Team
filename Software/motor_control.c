...
//global enc target variables
volatile int enc_r_target = 0;
volatile int enc_l_target = 0;
...
void pid_control (int target_distance, int move) {
    enc_l_target = CPR * target_distance / (PI * wheel_diameter); 
    enc_r_target = CPR * target_distance / (PI * wheel_diameter); 
